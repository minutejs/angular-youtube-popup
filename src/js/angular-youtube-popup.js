        ...
        function AngularYouTubePopup() {
            ...
            this.$get = function ($rootScope, youtubeEmbedUtils, $ui) {
                ...
                service.popup = function (videoUrl, title, modal, playerVars) {
                    ...
                    if (playerVars === void 0) { playerVars = { autoplay: 1, controls: 0, modestbranding: 1, rel: 0, showInfo: 0 }; }
                    console.log("videoUrl, title: ", videoUrl, title);
                    $ui.popup(template, modal, null, { ctrl: _this, data: { videoUrl: videoUrl, playerVars: playerVars, title: title } });
                };
            ...
            this.link = function ($scope, element, attrs) {
                element.click(function (event) {
                    ...
                    if (/youtube\.com/i.test(href)) {
                        _this.$youtube.popup(href, element.text());
